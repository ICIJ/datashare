...
public final class DatashareCliOptions {
    ...
    public static final String DEFAULT_ELASTICSEARCH_ADDRESS = "http://" + EnvUtils.resolveHost("elasticsearch") + ":9200";
    ...
    public static final String DEFAULT_MESSAGE_BUS_ADDRESS = "redis://" + EnvUtils.resolveHost("redis") + ":6379";
    ...
    public static final String DEFAULT_REDIS_ADDRESS = "redis://" + EnvUtils.resolveHost("redis") + ":6379";
