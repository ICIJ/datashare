...
@Command(name = "start", mixinStandardHelpOptions = true,
        description = {"Start the Datashare web application server.", "", "Examples:", "  datashare app start",
...
public class AppServeCommand implements Runnable, DatashareSubcommand {
    @Option(names = {"--mode"}, defaultValue = "LOCAL", paramLabel = "LOCAL|SERVER|EMBEDDED|NER",
