...
@Command(name = "list", mixinStandardHelpOptions = true,
        description = {"List available extensions from the registry.", "", "Examples:", "  datashare extension list",
                "  datashare extension list nlp"})
public class ExtensionListCommand implements Runnable, DatashareSubcommand {
    @Parameters(index = "0", arity = "0..1", defaultValue = "true", description = "Optional filter pattern")
    String filter;
