...
$JAVA -agentlib:jdwp=transport=dt_socket,server=y,address=8000,suspend=n -Djava.system.class.loader=org.icij.datashare.DynamicClassLoader -Djavax.net.ssl.trustStorePassword=changeit \
