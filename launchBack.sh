...
export DS_DOCKER_BACK_HOST="http://localhost:$(sudo docker ps|grep 8080|sed 's/.*0.0.0.0:\(.*\)->8080.*/\1/g')"
export DS_DOCKER_FRONT_HOST="http://localhost:$(sudo docker ps|grep 9090|sed 's/.*0.0.0.0:\(.*\)->9090.*/\1/g')"
