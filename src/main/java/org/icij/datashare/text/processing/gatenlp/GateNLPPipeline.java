...
public final class GateNLPPipeline extends AbstractNLPPipeline {
    ...
    // Gate annotation types: {Person, Company, Country} + {Token, Sentence}
...
//        File resourceDirectory = new File( resDirURL.getFile() );
            ...
            Path resourceDirectoryPath = Paths.get(System.getProperty("user.dir"), "src", "main", "resources", RESOURCES_BASEDIR.toString());
