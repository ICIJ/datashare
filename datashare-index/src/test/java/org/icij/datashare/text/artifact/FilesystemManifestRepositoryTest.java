...
public class FilesystemManifestRepositoryTest {
    ...
    public void test_concurrent_put_of_two_types_keeps_both() throws Exception {
        ...
        Runnable b = () -> { try { start.await(); repository.put(node, "structure", ManifestEntry.paginated(Map.of("type", "structure", "version", 1), 9).withStatus(ManifestEntryStatus.COMPLETE)); } catch (Exception e) { throw new RuntimeException(e); } };
