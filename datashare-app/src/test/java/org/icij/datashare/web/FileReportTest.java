...
public class FileReportTest {
    ...
    public void test_file_report_visitor_with_depth_one() throws IOException {
        ...
        List<FileReport> children = rootReport.getChildren();
        assertThat(children).hasSize(3);
        assertThat(children.get(2).file.getName()).isEqualTo("foo");
        assertThat(children.get(2).getChildren()).hasSize(0);
    }
    ...
    public void test_file_report_visitor_with_depth() throws IOException {
        ...
        assertThat(rootReport.getChildren().get(2).file.getName()).isEqualTo("foo");
        assertThat(rootReport.getChildren().get(2).getChildren()).hasSize(1);
        assertThat(rootReport.getChildren().get(2).getChildren().get(0).file.getName()).isEqualTo("bar.txt");
    }
