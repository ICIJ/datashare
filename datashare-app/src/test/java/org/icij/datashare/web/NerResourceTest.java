...
public class NerResourceTest extends AbstractProdWebServerTest {
    ...
    @Test
    public void test_post_text_returns_named_entity_list() throws Exception {
        ...
        doReturn(List.of(NamedEntity.create(NamedEntity.Category.PERSON, "foù", List.of(10L), doc.getId(), "root", CORENLP, ENGLISH)))
            .when(pipeline)
            .processDoc(eq(doc));
