...
public class ExtractNlpTaskTest {
    ...
    public void setUp() {
        initMocks(this);
        nlpTask = new ExtractNlpTask(indexer, pipeline, factory, new DatashareTask<>(ExtractNlpTask.class.getName(), User.local(),
    ...
    public void test_exit_after_nb_max_attempts()  throws Exception  {
        ExtractNlpTask nlpTask = new ExtractNlpTask(indexer, pipeline, factory, new DatashareTask<>(ExtractNlpTask.class.getName(), User.local(),
