...
public class IndexTaskTest {
    ...
    public void test_options_include_ocr() throws Exception {
        ...
        IndexTask indexTask = new IndexTask(spewer, mock(DocumentCollectionFactory.class), new DatashareTask<>(IndexTask.class.getName(), nullUser(), new HashMap<>(){{
    ...
    public void test_configure_called_on_spewer() throws Exception {
        ...
        new IndexTask(spewer, mock(DocumentCollectionFactory.class), new DatashareTask<>(IndexTask.class.getName(), nullUser(), Map.of("charset", "UTF-16")), null);
    ...
    public void test_configure_project_on_spewer() throws Exception {
        ...
        new IndexTask(spewer, mock(DocumentCollectionFactory.class), new DatashareTask<>(IndexTask.class.getName(), nullUser(), Map.of("defaultProject", "foo", "projectName", "bar")), null);
