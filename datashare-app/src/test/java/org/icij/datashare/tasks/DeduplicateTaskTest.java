...
public class DeduplicateTaskTest {
    ...
    DeduplicateTask task = new DeduplicateTask(docCollectionFactory, new Task<>(DeduplicateTask.class.getName(), User.local(), new Group(TaskGroupType.Test), defaultOpts), null);
    ...
    public void test_filter_empty() throws Exception {
        ...
        assertThat(new DeduplicateTask(docCollectionFactory, new Task<>(DeduplicateTask.class.getName(), User.local(), new Group(TaskGroupType.Test), defaultOpts), null).call()).isEqualTo(0);
    }
    ...
    public void test_filter_queue_removes_duplicates() throws Exception {
        ...
        assertThat(new DeduplicateTask(docCollectionFactory,  new Task<>(DeduplicateTask.class.getName(), User.local(), new Group(TaskGroupType.Test), defaultOpts), null).call()).isEqualTo(1);
