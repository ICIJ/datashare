...
public class DeduplicateTaskTest {
    ...
    public void test_filter_empty() throws Exception {
        ...
        assertThat(new DeduplicateTask(docCollectionFactory, new Task(DeduplicateTask.class.getName(), User.local(), defaultOpts), null).call().value()).isEqualTo(0);
    }
    ...
    public void test_filter_queue_removes_duplicates() throws Exception {
        ...
        assertThat(new DeduplicateTask(docCollectionFactory,  new  Task(DeduplicateTask.class.getName(), User.local(), defaultOpts), null).call().value()).isEqualTo(1);
