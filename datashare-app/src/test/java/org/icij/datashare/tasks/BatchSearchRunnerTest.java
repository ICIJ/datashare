...
public class BatchSearchRunnerTest {
    ...
    public void test_run_batch_search_truncate_to_60k_max_results() throws Exception {
        ...
        assertThat((int)new BatchSearchRunner(indexer, new PropertiesProvider(), repository, taskView(batchSearch), progressCb).call().value()).isLessThan(60000);
    }
    ...
    public void test_cancel_current_batch_search() throws Exception {
        ...
        Future<DatashareTask<Integer>> result = executor.submit(batchSearchRunner);
        executor.shutdown();
