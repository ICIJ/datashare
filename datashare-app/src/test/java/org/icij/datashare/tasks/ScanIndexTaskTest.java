...
public class ScanIndexTaskTest {
    ...
    public void test_empty_index() throws Exception {
        assertThat(new ScanIndexTask(documentCollectionFactory, indexer, new Task(
                ScanIndexTask.class.getName(), User.nullUser(), propertiesToMap(propertiesProvider.getProperties())), null).call().value()).isEqualTo(0);
    }
    ...
    public void test_transfer_indexed_paths_to_filter_set() throws Exception {
        ...
        assertThat(new ScanIndexTask(documentCollectionFactory, indexer,  new Task(
                ScanIndexTask.class.getName(), User.nullUser(), propertiesToMap(propertiesProvider.getProperties())), null).call().value()).isEqualTo(2);
