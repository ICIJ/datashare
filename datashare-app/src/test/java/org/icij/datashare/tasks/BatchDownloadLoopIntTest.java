...
public class BatchDownloadLoopIntTest {
    private LinkedBlockingQueue<TaskView<?>> batchDownloadQueue = new LinkedBlockingQueue<>();
    ...
    public void test_batch_download_task_view_properties() {
        ...
        BatchDownloadLoop batchDownloadLoop = new BatchDownloadLoop(new PropertiesProvider(), null, factory, taskManager);
