...
public class EnqueueFromIndexTaskTest {
    ...
    public void test_size_of_search() throws Exception {
        ...
        EnqueueFromIndexTask enqueueFromIndex = new EnqueueFromIndexTask(factory, indexer, new DatashareTask<>(EnqueueFromIndexTask.class.getName(), new User("test"), properties), null);
