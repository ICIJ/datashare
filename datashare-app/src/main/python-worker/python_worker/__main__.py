...
from python_worker.icij_worker import main as icij_worker_main, main_amqp as icij_worker_main_amqp
...
def _setup_loggers():
    level = logging.DEBUG
    loggers = ["__main__", python_worker.__name__, "icij_worker", stomp.__name__, proton.__name__]
