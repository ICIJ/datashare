...
public class DatashareUser extends User implements net.codestory.http.security.User {
    public DatashareUser(Map<String, Object> map) {
        super(map);
    }

    public DatashareUser(String id) {
        super(id);
    }
    ...
    public static Users singleUser(String name, String... projectNames) {
        return singleUser(User.localUser(name, projectNames));
    }

    public static Users singleUser(String name) {
        return singleUser(User.localUser(name));
    }
