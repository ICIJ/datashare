...
public class ContentTypeResource {
    @Operation(description = "Returns the list of contentTypes in parameter grouped by contentTypeCategories",
            parameters = {@Parameter(name = "contentTypes", description = "The list of contentTypes to group",
                    in = ParameterIn.QUERY),})
    @ApiResponse(responseCode = "200", description = "The list of contentTypes was successfully grouped",
