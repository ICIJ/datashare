...
public class ExtensionResource {
    ...
    public Payload uninstallExtension(@Parameter(name = "extensionId", description = "id of the extension to uninstall",
            in = ParameterIn.QUERY) String extensionId) throws IOException {
        try {
