...
public class DeduplicateTask extends PipelineTask<Path> {
    ...
    @Inject
    public DeduplicateTask(final DocumentCollectionFactory<Path> factory, @Assisted  Task taskView, @Assisted final Function<Double, Void> updateCallback) {
    ...
    public DatashareTaskResult<Long> call() throws Exception {
        ...
        return new DatashareTaskResult<>((long)duplicates);
    }
