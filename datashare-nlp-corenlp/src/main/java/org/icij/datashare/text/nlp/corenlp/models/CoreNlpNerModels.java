...
public class CoreNlpNerModels extends CoreNlpModels<AbstractSequenceClassifier<CoreLabel>> {
    ...
    @Override
    protected CoreNlpAnnotator<AbstractSequenceClassifier<CoreLabel>> loadModelFile(Language language) throws IOException {
    ...
    private CoreNlpNerModels() {
        ...
        modelNames.put(HUNGARIAN, "ner/hungarian.crf.ser.gz");
        modelNames.put(ITALIAN, "ner/italian.crf.ser.gz");
    }
    @Override
