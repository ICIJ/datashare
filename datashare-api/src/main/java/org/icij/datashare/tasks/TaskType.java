...
public enum TaskType {
    ...
    ARTIFACT("org.icij.datashare.tasks.ArtifactTask"), GEN_API_KEY("org.icij.datashare.tasks.GenApiKeyTask"),
    ...
    public static Optional<TaskType> fromName(String fqdn) {
        ...
        return Arrays.stream(values()).filter(t -> t.names.contains(fqdn)).findFirst();
    }
