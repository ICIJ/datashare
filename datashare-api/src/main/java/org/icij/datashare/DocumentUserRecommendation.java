...
public class DocumentUserRecommendation {
    ...
    @JsonCreator
    public DocumentUserRecommendation(@JsonProperty("document") Document document,
                                      @JsonProperty("project") ProjectProxy project, @JsonProperty("user") User user,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(project, that.project) && Objects.equals(document, that.document) &&
