...
public record ManifestEntry(ManifestEntryStatus status, Map<String, Object> taskInput, Pages pages, String contentType, String filename, Double confidence, String label, String taskId) {
    ...
    public static ManifestEntry paginated(Map<String, Object> taskInput, List<long[]> ranges) {
        return new ManifestEntry(null, taskInput, new Pages(ranges.size(), new ByteRangePagination(ranges)), null, null,
                                 null, null, null);
    }
