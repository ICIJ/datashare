...
public final class TikaDocumentParser implements DocumentParser {
    ...
    public Optional<Language> getLanguage() {
        if (metadata == null || ! asList(metadata.names()).contains(CONTENT_LANGUAGE))
    ...
    public OptionalInt getLength() {
        if (metadata == null || ! asList(metadata.names()).contains(CONTENT_LENGTH))
    ...
    public Optional<Charset> getEncoding() {
        if (metadata == null || ! asList(metadata.names()).contains(Metadata.CONTENT_ENCODING))
            return Optional.empty();
    ...
    public Optional<String> getName() {
        if (metadata == null || ! asList(metadata.names()).contains(RESOURCE_NAME))
            return Optional.empty();
    ...
    public Optional<String> getType() {
        if (metadata == null || ! asList(metadata.names()).contains(CONTENT_TYPE))
            return Optional.empty();
